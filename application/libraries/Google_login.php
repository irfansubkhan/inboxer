...
&access_type=online&approval_prompt=auto";
		return "<a href='{$login_url}' class='btn' style='font-family:Roboto;border:1px solid #999;border-radius:4px;padding-top:15px;padding-bottom:15px;color:rgba(0,0,0,.54);'> <img style='width:25px;display:inline;float:left;' src='".base_url('assets/images/google.png')."'> <span style='position:relative;left:-20px;font-weight:500;' class='google_text'>ThisIsTheLoginButtonForGoogle</span></a>";
	}
