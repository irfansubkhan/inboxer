...
class Paypal_ipn extends CI_Controller
{
    ...
    public function ipn_notify_main()
    {
        ...
        $country= isset($payment_info['data']['address_country']) ? $payment_info['data']['address_country']:""; 
        ...
        $payment_type=isset($payment_info['data']['payment_type']) ? $payment_info['data']['payment_type']:""; 
