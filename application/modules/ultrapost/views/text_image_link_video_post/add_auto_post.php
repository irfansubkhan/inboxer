...
<div class="row padding-20" style="padding-top: 5px;">
	<div class="col-xs-12 col-md-6 padding-5">
		<div class="box box-primary">
			...
			<div class="box-body">
				<a href="#" id="text_post" class="post_type active"><i class="fa fa-dedent"></i> <span class="hidden-xs" title="Text"><?php echo $this->lang->line('Text'); ?></span></a>
	...
	<div class="col-xs-12 col-md-6 padding-5">
		<div class="box box-primary">
			...
			<div class="box-body preview">				
				...
				<span class="preview_page"><?php echo $fb_user_info[0]['name'];?></span><br/>
