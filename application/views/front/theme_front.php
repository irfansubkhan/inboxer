...
<div class="container-fluid front_content">
 ...
 <!-- footer -->
<footer id="footer" class='sticky_bottom' style="background:  <?php echo $THEMECOLORCODE;  ?>">
<div class="container-fluid text-center">
    <div class="row">
        <div class="col-xs-12">             
             <?php echo $this->config->item("product_name")." ".$this->APP_VERSION.' - <a target="_BLANK" href="'.site_url().'"><b>'.$this->config->item("institute_address1").'</b></a>'; ?> 
             </div>
    </div>
    </div>
</footer>
