...
<section class="content-header">
  <h1><i class="fa fa-paypal"></i> <?php echo $this->lang->line("payment option"); ?> </h1>

</section>

<!-- Main content -->
<section  style="margin:15px;background: #fff!important;border:1px solid #ccc;" class="alert alert-warning">
  <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
        <?php
        $packages[""]=$this->lang->line("choose package");
        echo form_dropdown('choose_package',$packages,"",'class="form-control" id="choose_package" style="height:50px;font-size:15px;"'); 
      ?> 
      </div> 
...
<section class="content-header">
  <h1><i class='fa fa-history'></i> <?php echo $this->lang->line("payment history"); ?> </h1>
...
<section class="content">  
  ...
  <div class="row">
    <div class="col-xs-12">
        <div class="grid_container" style="width:100%; height:622px;">
            <table 
            id="tt"  
