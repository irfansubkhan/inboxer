...
<div class="row" style="padding:10px;">
	...
	<div class="col-lg-4 col-xs-12 col-md-4">
		...
		<div class="small-box bg-blue">
			<div class="inner">
				<h4><?php echo $total_paid_amount." ".$currency; ?></h4>
...
<div class="row" style="padding:10px;">
	<!-- Info Boxes Style 2 -->
	<div class="col-xs-12"><h4 class="text-center dynamic_font_color"><?php echo $this->lang->line("Today's Report") ?></h4><br></div>
	<div class="col-md-4 col-md-offset-2 col-sm-6 col-xs-12">
	...
	<div class="col-md-4 col-sm-6 col-xs-12">
		<div class="info-box bg-blue">
			...
			<div class="info-box-content">
				...
				<span class="info-box-number" style="color:#fff !important;"><?php echo $today_paid_amount." ".$currency; ?></span>
				<div class="progress">
					<div class="progress-bar" style="width: 70%"></div>
				</div>
				<span class="progress-description">
