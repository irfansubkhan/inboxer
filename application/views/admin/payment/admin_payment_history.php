...
<section class="content-header">
  <h1><i class="fa fa-dollar"></i> <?php echo $this->lang->line("payment history"); ?> </h1>
...
<section class="content">  
  <div class="row">
    <div class="col-xs-12">
        <div class="grid_container" style="width:100%; height:552px;">
            <table 
            id="tt"  
       ...
       <div id="tb" style="padding:3px">
            <h4><?php echo $this->lang->line("total paid amount"); ?>: <?php echo $total_paid_amount." ".$currency; ?></h4> 
