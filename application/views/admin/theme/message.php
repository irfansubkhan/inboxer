<?php 
	...
	if($this->session->flashdata('broadcast_success')==1)
	{		
		echo "<div class='alert alert-success text-center'><h4 style='margin:0;'><i class='fa fa-check-circle'></i> ".$this->lang->line("campaign information has been saved successfully.")."</h4></div>";
	}
	...
	echo "<div class='alert alert-danger text-center'><h4 style='margin:0;'><i class='fa fa-remove'></i> ".$this->lang->line("sorry! your data does not exist.")."</h4></div>";
