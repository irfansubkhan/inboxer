...
<style>#recovery_form{text-align:center;}</style>
  <div class="row" style="padding-left:15px;padding-right:15px;">    
    ...
    <h6 class="column-title"><i class="fa fa-cog fa-2x blue"> Install <?php echo $this->config->item('product_short_name');?> Package</i> (<a href="https://clck.ru/EFSmf" target="_blank">BINGO</a>)</h6>
  ...
  <div class="col-sm-12 col-xs-12 col-md-5 col-lg-5 border_gray grid_content padded background_white alert alert-warning">
      ...
      <?php if($install_allow==1) :?>
        <div class="alert alert-info text-center"><b>EZ INBOXER NULLED BY AMAZCODE</b></div>
      <?php else : ?>
