		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<form action="#" enctype="multipart/form-data" id="inbox_campaign_form" method="post">
					...
					<br>
					<div class="box-footer clearfix" style="border-top: none !important;">
						<!-- <div class="col-xs-12"> -->
							<button style='width:100%;margin-bottom:10px;' class="btn btn-primary center-block btn-lg" id="submit_post" name="submit_post" type="button"><i class="fa fa-edit"></i> <?php echo $this->lang->line("edit campaign") ?> </button>
						<!-- </div> -->
					</div>					
...
<script>
	...
	$j("document").ready(function(){
        ...
        $(document.body).on('click','.ms-parent input[type=checkbox]',function(){   
    		...
    		$.ajax({
		       ...
		       { 
		       	 ...
		       	 {
		       	 	alertify.alert('<?php echo $this->lang->line("Alert");?>',sorryyourmonthlylimittosendmessageisxceede,function(){ });
	    ...
	    $(document.body).on('click','#submit_post',function(){ 
        	...
        	if(inbox_to_pages==null)
        	{
        		alertify.alert('<?php echo $this->lang->line("Alert");?>',pleaseselectgroupstocreateinboxcampaign,function(){ });
        		return;
        	}
