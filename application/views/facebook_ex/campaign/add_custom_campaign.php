...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-random"></i> <?php echo $this->lang->line("custom campaign : lead list");?></h1>
</section>
<section class="content">  
	<div class="row" >
		<div class="col-xs-12">
			<div class="grid_container" style="width:100%; height:875px;">
				<table 
				id="tt"  
						...
						<div class="box box-primary">
							...
							<div class="box-body">
								<form action="#" enctype="multipart/form-data" id="inbox_campaign_form" method="post">
									...
									<div class="form-group">
										<label><?php echo $this->lang->line("paste url") ?> <small>(<?php echo $this->lang->line("will be attached & previewed") ?>)</small>
									...
									<div class="form-group">
										<label><?php echo $this->lang->line("paste youtube video url") ?><small>(<?php echo $this->lang->line("will be attached & previewed") ?>)</small>
	...
	$j("document").ready(function(){
        ...
        $(document.body).on('click','#create_new_custom_campaign',function(){ 
        	var rows = $j('#tt').datagrid('getSelections');
          	...
          	if(rows=="") 
	        {
	            alertify.alert('<?php echo $this->lang->line("Alert");?>',pleaseselectoneormoreupto+" "+upto+""+leadstocreatecustomcampaign,function(){ });
	            return;
	        }
	        if(selected>upto) 
	        {
	        ...
	        if(link!='')
	        {
	            ...
	            success:function(response){	 
	            	...
	            	$("#preview_loading").hide();          		                
               	 	...
               	 	{
               	 		alertify.alert('<?php echo $this->lang->line("Alert");?>',urlisinvalid,function(){ });
               	 		$("#link").val("");
               	 		$("#link_thumb").hide();
	        ...
	        if(link!='')
	        {
	            ...
	            success:function(response){	           		                
	       			...
	       			$("#preview_loading").hide();   
               	 	if(response.status=='0')
               	 	{
               	 		alertify.alert('<?php echo $this->lang->line("Alert");?>',youtubeURLisinvalid,function(){ });
               	 		$("#video_url").val("");
               	 		$("#video_thumb").hide();
               	 	}
               	 	else
	    ...
	    $(document.body).on('click','#submit_test_post',function(){ 
	    	...
	    	{
	    		alertify.alert('<?php echo $this->lang->line("Alert");?>',pleasechooseanyleadtosendtestmessagea,function(){ });
	    	 	return;
	    	}
	    	var message = $("#message").val();
	    	var link = $("#link").val();
    		...
    		{
    			alertify.alert('<?php echo $this->lang->line("Alert");?>',pleasetypeamessageorpasteurlvideourl,function(){ });
    			return;
    		} 
    	    $("#test_loading").show();
	    ...
	    $(document.body).on('click','#submit_post',function(){ 
            ...
            {
            	alertify.alert('<?php echo $this->lang->line("Alert");?>',sorryyourmonthlylimittocreatecampaignisexceededYoucannotcreateanothercampaignthismonth,function(){ });
            	return;
            }
    		...
    		{
    			alertify.alert('<?php echo $this->lang->line("Alert");?>',pleasetypeamessageorpasteurlvideourlystemcannotsendblankmessage,function(){ });
    			return;
    		}        	              	
        	...
        	{
        		alertify.alert('<?php echo $this->lang->line("Alert");?>',pleaseelectscheduletimetimezone,function(){ });
        		return;
        	}
