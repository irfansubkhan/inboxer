                ...
                <nav class="navbar">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <a href="#home" class="navbar-brand"><img style="max-height:45px !important" src="<?php echo base_url();?>assets/images/logo.png" alt="<?php echo $this->config->item('product_name');?>"></a>
                        </div>
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                            <div class="welcome-text">
                                ...
                                <div class="home-button">
                                    <a <?php if($this->config->item('enable_signup_form') =='0') echo "style='position:relative; left:190px;'"; ?> href="#features"><?php echo $this->lang->line("detailed features"); ?></a>
            ...
            <div class="row">
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="qs-box relative mb50 center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h3><?php echo $this->lang->line("Multiple Facebook Account"); ?></h3>
                        <p><?php echo $this->lang->line("Able to import multiple facebook accounts."); ?></p>
                    </div>
                </div>
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="qs-box relative mb50 center wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <p><?php echo $this->lang->line("Send bulk message to your Messenger leads."); ?></p>
                    </div>
                </div>
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="qs-box relative mb50 center wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <p><?php echo $this->lang->line("You Can Post Text,Image,Link,Video or carousel/video to your facebook page."); ?></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            <div class="qs-box relative mb50 pos-icon-left  wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <p><?php echo $this->lang->line("Has the feature of sending BULK messages without app approval."); ?></p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="download-content sm-center xs-center xs-mb50 xs-font wow fadeIn">
                        ...
                        <?php if(isset($default_package[0])) : ?>
                        	<a href="<?php echo site_url('home/sign_up'); ?>" class="download-button wow shake <?php if($this->config->item('enable_signup_form') == '0') echo "hidden"; ?>"><i class="fa fa-shopping-cart"></i><?php echo $this->lang->line("Free Trial"); ?> <span><?php echo $default_package[0]["validity"] ?> <?php echo $this->lang->line("Days"); ?></span></a>
                    	<?php endif; ?>
                    </div>
                </div>
